    ...
    <>
      ...
      <section className="relative bg-yellow-50 py-20 md:py-32">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div
            className="relative h-64 md:h-94"
      ...
      <Section background="white" padding="normal">
        ...
        >
          {/* Benefit 1 */}
          <StaggerItem className="text-center flex flex-col items-center">
            <ScaleIn delay={0.1}>
          ...
          <FadeIn delay={0.3}>
            ...
            >
              ...
              <div className="text-lg text-gray-700 mb-6 pt-6 pl-10">
                ...
                bertahun-tahun. Rasanya sangat netral dan membuat gorengan
                menjadi lebih renyah. Tidak pernah mengecewakan dan selalu
                menjadi pilihan utama untuk keluarga kami."
              </div>
