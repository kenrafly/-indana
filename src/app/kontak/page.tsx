    ...
    <>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="bg-yellow-100 hover:bg-yellow-200 p-3 rounded-full transition-colors"
                  >
                    <svg
                      className="w-6 h-6 text-yellow-600"
                      fill="currentColor"
      ...
      <Section background="light" padding="normal">
        ...
        <div className="rounded-lg overflow-hidden shadow-lg h-96 relative">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92775.5396960529!2d112.78946199288848!3d-7.04735913306345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd819888981e67b%3A0x3027a76e3cd8a70!2sBangkalan%20Regency%2C%20East%20Java!5e1!3m2!1sen!2sid!4v1751879122005!5m2!1sen!2sid"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen={true}
            loading="lazy"
            title="Lokasi PT Indana"
          ></iframe>
        </div>
      </Section>
    </>
